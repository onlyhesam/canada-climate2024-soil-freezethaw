...
if __name__ == '__main__':
    ...
    hdf_files = [os.path.join(hdf_directory, f) for f in os.listdir(hdf_directory) if fnmatch.fnmatch(f, '*accuracy*.h5')]
    print(hdf_files)
    ...
    all_results_df.to_csv(r'.\..\..\data\sample\ACs.csv', index=False)
